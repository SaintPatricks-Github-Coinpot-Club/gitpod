...
internal class GitpodAuthCallbackHandler : RestService() {
    ...
    override fun execute(
        ...
        val isAccepted = service.handleServerCallback(urlDecoder.path(), urlDecoder.parameters())
        // TODO(ak) render auth result path and redirect back to gateway using custom URI handler
        return null
    }
}